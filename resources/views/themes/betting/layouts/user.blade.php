    ...
    <div class="leftbar" id="userPanelSideBar">
        <div class="px-2 d-lg-none">
            <button
                ...
                <i class="fal fa-chevron-left"></i>@lang('Voltar ao início')
            </button>
        </div>
