...
@section('title',trans('Minha Conta'))
@section('content')
    <!-- contents -->
    <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info">@lang('Total em Conta')</p>
                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info">@lang('Valor total da aposta')</p>
                </div>
                <div class="dashboard__card-icon">
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info">@lang('Aposta total')</p>
                </div>
                <div class="dashboard__card-icon">
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info">@lang('Aposta ganha')</p>
                </div>
                <div class="dashboard__card-icon">
