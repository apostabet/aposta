...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button class="btn-custom w-100"><?php echo app('translator')->get('Login'); ?></button>
                            <div class="bottom">
                                <?php echo app('translator')->get("Don't have an account?"); ?>

                                <a href="<?php echo e(route('register')); ?>"><?php echo app('translator')->get('Sign up'); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aposta\resources\views/themes/betting/auth/login.blade.php ENDPATH**/ ?>