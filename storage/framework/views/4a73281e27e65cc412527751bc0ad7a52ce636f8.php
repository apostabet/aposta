...
<nav class="navbar navbar-expand-md fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(menuActive('home')); ?>" href="<?php echo e(route('home')); ?>"><?php echo app('translator')->get('Inicio'); ?> </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(menuActive('about')); ?>" href="<?php echo e(route('about')); ?>"><?php echo app('translator')->get('Quem Somos'); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(menuActive('about')); ?>" href="<?php echo e(route('rules')); ?>"><?php echo app('translator')->get('Regras'); ?></a>
                </li>
                
                
                <li class="nav-item">
                    <a class="nav-link <?php echo e(menuActive('contact')); ?>" href="<?php echo e(route('contact')); ?>"><?php echo app('translator')->get('Contato'); ?></a>
                </li>
            </ul>
        </div>
                        ...
                        <li>
                            <a class="dropdown-item <?php echo e(menuActive('user.betHistory')); ?>"
                               href="<?php echo e(route('user.betHistory')); ?>">
                                ...
                                <?php echo app('translator')->get('Histórico de apostas'); ?>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                ...
                                <?php echo app('translator')->get('Sair'); ?>
                            </a>
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <ul class="notification-dropdown">
                        ...
                        <div class="clear-all fixed-bottom">
                            ...
                            <a v-if="items.length == 0" href="javascript:void(0)"><?php echo app('translator')->get('Você não tem notificações'); ?></a>
                        </div>
                    </ul>
                    <?php endif; ?>
                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\aposta\resources\views/themes/betting/partials/nav.blade.php ENDPATH**/ ?>