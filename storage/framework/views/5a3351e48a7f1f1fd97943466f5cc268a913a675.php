<?php $__env->startSection('title',trans('Minha Conta')); ?>
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info"><?php echo app('translator')->get('Total em Conta'); ?></p>
                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info"><?php echo app('translator')->get('Valor total da aposta'); ?></p>
                </div>
                <div class="dashboard__card-icon">
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info"><?php echo app('translator')->get('Aposta total'); ?></p>
                </div>
                <div class="dashboard__card-icon">
        ...
        <div class="col-xl-3 col-lg-4 col-md-3 col-sm-10 mb-2">
            <div class="dashboard__card">
                <div class="dashboard__card-content">
                    ...
                    <p class="info"><?php echo app('translator')->get('Aposta ganha'); ?></p>
                </div>
                <div class="dashboard__card-icon">
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bra93269/teste.epontobr.com.br/resources/views/themes/betting/user/dashboard.blade.php ENDPATH**/ ?>