                ...
                <div class="row mt-5 justify-content-center">
                    ...
                    <div class="col-md-3 d-none">
                        <div class="image-input ">
                            ...
                            <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(config('location.language.path').$language->flag)); ?>"
                                 alt="preview image">
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aposta\resources\views/admin/language/edit.blade.php ENDPATH**/ ?>