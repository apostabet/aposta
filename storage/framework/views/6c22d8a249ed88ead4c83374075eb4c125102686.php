            ...
            <div class="notification-panel" id="pushNotificationArea">
                ...
                <!-- login register button -->
                    <button
                        ...
                        <?php echo app('translator')->get('Juntar'); ?>
                    </button>
                    <button
                        class="btn-custom"
                        data-bs-toggle="modal"
                        data-bs-target="#loginModal">
                        <?php echo app('translator')->get('Entrar'); ?>
                    </button>
                <?php endif; ?>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /home2/bra93269/teste.epontobr.com.br/resources/views/themes/betting/partials/nav.blade.php ENDPATH**/ ?>