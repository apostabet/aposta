                    ...
                    <div class="col-md-6 col-lg-3 ps-lg-5">
                        <div class="footer-box">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo e(route('rules')); ?>"><?php echo app('translator')->get('Regras'); ?></a>
                                </li>
                                <li>
...
<?php /**PATH C:\laragon\www\aposta\resources\views/themes/betting/partials/footer.blade.php ENDPATH**/ ?>