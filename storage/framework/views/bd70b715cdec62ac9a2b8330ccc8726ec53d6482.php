    ...
    <div class="leftbar" id="userPanelSideBar">
        <div class="px-2 d-lg-none">
            <button
                ...
                <i class="fal fa-chevron-left"></i><?php echo app('translator')->get('Voltar ao início'); ?>
            </button>
        </div>
        ...
        <ul class="main">
            ...
            <li>
                <a href="<?php echo e(route('user.ticket.list')); ?>" class="<?php echo e(menuActive('user.ticket.list')); ?>">
                    ...
                    <?php echo app('translator')->get('Tickets de suporte'); ?>
                </a>
            </li>
            <li>
...
<?php /**PATH /home2/bra93269/teste.epontobr.com.br/resources/views/themes/betting/layouts/user.blade.php ENDPATH**/ ?>