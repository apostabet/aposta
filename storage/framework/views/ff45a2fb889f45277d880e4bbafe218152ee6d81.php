    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4><?php echo app('translator')->get('Login'); ?></h4>
                <button
                    type="button"
                    class="btn-close"
            ...
            <div class="modal-body">
                <form class="login-form" id="login-form" action="<?php echo e(route('loginModal')); ?>" method="post">
                    ...
                    <div class="row g-4">
                        <div class="input-box col-12">
                            <input
                                ...
                                name="username"
                                class="form-control"
                                placeholder="<?php echo app('translator')->get('Usuário'); ?>"/>
                        ...
                        <div class="input-box col-12">
                            <input
                                ...
                                autocomplete="off"
                                class="form-control"
                                placeholder="<?php echo app('translator')->get('Senha'); ?>"
                            />
                            ...
                            <div class="links">
                                <div class="form-check">
                                    ...
                                    <label
                                        ...
                                        <?php echo app('translator')->get('Lembre-Me'); ?>
                                    </label>
                                </div>
                                <a href="<?php echo e(route('password.request')); ?>"><?php echo app('translator')->get('Esqueceu a senha?'); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bottom">
                        <?php echo app('translator')->get("Não tem uma conta?"); ?>

                        <a href="<?php echo e(route('register')); ?>"><?php echo app('translator')->get('Registre-se'); ?></a>
                    </div>
                </form>
            </div>
        </div>
...
<div
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4><?php echo app('translator')->get('Cadastre-se'); ?></h4>
                <button
                    type="button"
                    class="btn-close"
                    data-bs-dismiss="modal"
                    ...
                    <div class="row g-4">
                        <div class="input-box col-12">
                            <input
                                ...
                                class="form-control"
                                placeholder="<?php echo app('translator')->get('Primeiro Nome'); ?>"/>
                        ...
                        <div class="input-box col-12">
                            <input
                                ...
                                class="form-control"
                                placeholder="<?php echo app('translator')->get('Último Nome'); ?>"/>
                        ...
                        <div class="input-box col-6">
                            ...
                            <select
                                ...
                                <option selected="" disabled><?php echo app('translator')->get('Codigo do País'); ?></option>
                        ...
                        <div class="input-box col-6">
                            <input
                                ...
                                placeholder="<?php echo app('translator')->get('Telefone'); ?>"/>
                        ...
                        <div class="input-box col-12 mb-3">
                            <input
                                ...
                                class="form-control"
                                placeholder="<?php echo app('translator')->get('Confirme Senha'); ?>"/>
                        </div>
                    </div>

                    <button type="submit" class="btn-custom w-100 login-signup-auth-btn"><?php echo app('translator')->get('Sign up'); ?></button>
                    <div class="bottom">
                        <?php echo app('translator')->get('Já tem uma conta?'); ?>

                        <a href="<?php echo e(route('login')); ?>"><?php echo app('translator')->get('Faça login aqui'); ?></a>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\aposta\resources\views/themes/betting/partials/modal-form.blade.php ENDPATH**/ ?>